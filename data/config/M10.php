...
return [
    ...
    //--------------//
      ...
      //        'expire'          => '10080',                   // Message expiration time in minutes (0 mean unlimited)
      ...
      //      'room2' => [
      //        'description'     => 'The room1 description',   // Description of the room
      //        'expire'          => '10080',                   // Message expiration time in minutes
      ...
      'rooms' => [
        'main' => [
          ...
          'max_messages'    => '100',
          'allow_guests'    => '0',
          'moderator_ids'   => ['9','12','13'],
          'recipients'      => []
        ],
        'dashboard_common' => [
          'description'     => 'The common room of dashboard',
          'expire'          => '10080',
          'messages_limit'  => '10000',
          'max_msg_length'  => '255',
          'max_messages'    => '100',

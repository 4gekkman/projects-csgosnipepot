...
// В. Класс-модель //
//-----------------//
class MD2_skins2order extends Model {
  ...
  protected $table = 'm14.md2_skins2order';
  ...
  //------------------//
    ...
    // relationships start
    public function purchases() { return $this->belongsToMany('\M14\Models\MD1_purchases', 'm14.md1001', 'id_skin2order', 'id_purchase'); }
    public function m8_items() { return $this->belongsToMany('\M8\Models\MD2_items', 'm14.md2005', 'id_skin2order', 'id_item')->withPivot(['price_coins_atbettime','price_cents_atbettime']); }
    // relationships stop

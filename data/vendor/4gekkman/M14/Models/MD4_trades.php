...
// В. Класс-модель //
//-----------------//
class MD4_trades extends Model {
  ...
  protected $table = 'm14.md4_trades';
  ...
  //------------------//
    ...
    // relationships start
    public function purchases() { return $this->belongsToMany('\M14\Models\MD1_purchases', 'm14.md1000', 'id_trade', 'id_purchase'); }
    public function safecodes() { return $this->belongsToMany('\M14\Models\MD6_safecodes', 'm14.md1003', 'id_trade', 'id_safecode'); }
    public function m5_users() { return $this->belongsToMany('\M5\Models\MD1_users', 'm14.md2001', 'id_trade', 'id_user'); }
    public function m8_items() { return $this->belongsToMany('\M8\Models\MD2_items', 'm14.md2002', 'id_trade', 'id_item')->withPivot(['assetid_bots','price_coins_atbettime','price_cents_atbettime']); }
    public function m8_bots() { return $this->belongsToMany('\M8\Models\MD1_bots', 'm14.md2003', 'id_trade', 'id_bot'); }
    // relationships stop
  ...
  //-----------------------------------------//
    ...
    //-----------------------------//
      ...
      //{
      //  return $this->hasMany('\M14\Models\MD2_y', 'id_y', 'id');
      //}
      ...
      //{
      //  return $this->belongsTo('\M14\Models\MD1_x', 'id_y', 'id');
      //}
      ...
      //{
      //  return $this->belongsToMany('\M14\Models\MD3_a', 'm14.md1000', 'id_b', 'id_a');
      //}

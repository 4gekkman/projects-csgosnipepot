...
// В. Класс-модель //
//-----------------//
class MD1_purchases extends Model {
  ...
  protected $table = 'm14.md1_purchases';
  ...
  //------------------//
    ...
    // relationships start
    public function trades() { return $this->belongsToMany('\M14\Models\MD4_trades', 'm14.md1000', 'id_purchase', 'id_trade'); }
    public function skins2order() { return $this->belongsToMany('\M14\Models\MD2_skins2order', 'm14.md1001', 'id_purchase', 'id_skin2order'); }
    public function m5_users() { return $this->belongsToMany('\M5\Models\MD1_users', 'm14.md2004', 'id_purchase', 'id_user'); }
    // relationships stop

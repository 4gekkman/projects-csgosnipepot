...
// В. Класс-модель //
//-----------------//
class MD6_safecodes extends Model {
  ...
  protected $table = 'm14.md6_safecodes';
  ...
  //------------------//
    ...
    // relationships start
    public function trades() { return $this->belongsToMany('\M14\Models\MD4_trades', 'm14.md1003', 'id_safecode', 'id_trade'); }
    // relationships stop

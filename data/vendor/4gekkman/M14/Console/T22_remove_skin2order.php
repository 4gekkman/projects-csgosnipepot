...
// Консольная команда //
//--------------------//
class T22_remove_skin2order extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm14:remove_skin2order';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Remove skin from skin2order table';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M14\Commands\C22_remove_skin2order', $this->argument());

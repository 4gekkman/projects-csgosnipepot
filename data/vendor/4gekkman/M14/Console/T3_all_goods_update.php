...
// Консольная команда //
//--------------------//
class T3_all_goods_update extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm14:all_goods_update';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Update goods unified cache via bot goods cache and cast cast add and subtract arrays via websocket public channel';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M14\Commands\C3_all_goods_update', $this->argument());

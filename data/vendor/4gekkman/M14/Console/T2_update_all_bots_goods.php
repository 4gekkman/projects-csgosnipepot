...
// Консольная команда //
//--------------------//
class T2_update_all_bots_goods extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm14:update_all_bots_goods';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Updates all shop bot goods in cache';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M14\Commands\C2_update_all_bots_goods', $this->argument());

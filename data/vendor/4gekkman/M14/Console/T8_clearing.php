 ...
 *  Что делает
 *  ----------
 *    - Crearing of waiting for payment trades
 *
 *  Аргументы
 *  ---------
 *
...
// Консольная команда //
//--------------------//
class T8_clearing extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm14:clearing';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Crearing of waiting for payment trades';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M14\Commands\C8_clearing', $this->argument());

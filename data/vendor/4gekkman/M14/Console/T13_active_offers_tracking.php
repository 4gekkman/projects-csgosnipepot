...
// Консольная команда //
//--------------------//
class T13_active_offers_tracking extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm14:active_offers_tracking';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M14\Commands\C13_active_offers_tracking', $this->argument());

...
// Консольная команда //
//--------------------//
class T14_active_to_accepted extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm14:active_to_accepted';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Convert the active trade offer to accepted';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M14\Commands\C14_active_to_accepted', $this->argument());

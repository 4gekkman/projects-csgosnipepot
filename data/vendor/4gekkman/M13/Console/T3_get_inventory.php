...
// Консольная команда //
//--------------------//
class T3_get_inventory extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm13:get_inventory';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Get inventory with time limit';
...
//    // 1. Выполнить команду
//    $result = runcommand('\M13\Commands\C1_command', $this->argument());
//
//
//    // 2. В случае неудачи, вывести текст ошибки
//    if($result['status'] != 0) {

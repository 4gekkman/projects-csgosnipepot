...
// В. Класс-модель //
//-----------------//
class MD1_nickpromo extends Model {
  ...
  protected $table = 'm17.md1_nickpromo';
  ...
  //------------------//
    ...
    // relationships start
    public function m5_users() { return $this->belongsToMany('\M5\Models\MD1_users', 'm17.md2000', 'id_nickpromo', 'id_user'); }
    // relationships stop
  ...
  //-----------------------------------------//
    ...
    //-----------------------------//
      ...
      //{
      //  return $this->hasMany('\M17\Models\MD2_y', 'id_y', 'id');
      //}
      ...
      //{
      //  return $this->belongsTo('\M17\Models\MD1_x', 'id_y', 'id');
      //}
      ...
      //{
      //  return $this->belongsToMany('\M17\Models\MD3_a', 'm17.md1000', 'id_b', 'id_a');
      //}

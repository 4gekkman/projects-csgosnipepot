...
// Консольная команда //
//--------------------//
class T2_get_nick_promo_info extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm17:get_nick_promo_info';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Get Nick Promo info';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M17\Commands\C2_get_nick_promo_info', $this->argument());

...
// Консольная команда //
//--------------------//
class T3_check_strings_in_nickname extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm17:check_strings_in_nickname';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Check strings in nickname';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M17\Commands\T3_check_strings_in_nickname.php', $this->argument());

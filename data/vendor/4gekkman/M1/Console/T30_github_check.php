 ...
 *  ---------
 *
 *    $path         // Путь к файлу, содержащему token к github
 *
 *  Опции
 *  -----
 *
...
// Консольная команда //
//--------------------//
class T30_github_check extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm1:github_check';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Checks if 4gekkman acc is accessible for the app';

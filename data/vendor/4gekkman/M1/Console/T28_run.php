 ...
 *  Что делает
 *  ----------
 *    - Runs console commands afterupdate and suf, if dev.mode is on (in M1 config)
 *
 *  Аргументы
 *  ---------
 *
...
class T28_run extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm1:run';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Runs console commands afterupdate and suf, if dev.mode is on (in M1 config)';

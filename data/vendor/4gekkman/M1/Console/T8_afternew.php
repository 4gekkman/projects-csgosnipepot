 ...
 *  Что делает
 *  ----------
 *    - Fires in 10 secs after the new resource had created. Invoke set of commands.
 *
 *  Аргументы
 *  ---------
 *
...
// Консольная команда //
//--------------------//
class T8_afternew extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm1:afternew';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Fires in 10 secs after the new resource had created. Invoke set of commands.';
  ...
  public function handle()
  {
    ...
    // Выполнить команду afternew через 10 секунд
    runcommand('\M1\Commands\C13_afternew',[],0,['on'=>true,'delaysecs'=>10]);

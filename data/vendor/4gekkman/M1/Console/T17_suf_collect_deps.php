...
// Консольная команда //
//--------------------//
class T17_suf_collect_deps extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm1:suf_collect_deps';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Collect all bower-dependencies from bower.json of DLW-packages to bower.json of the project';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M1\Commands\C39_suf_collect_deps');

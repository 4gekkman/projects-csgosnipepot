...
// В. Класс-модель //
//-----------------//
class MD5_commands extends Model {
  ...
  protected $table = 'm1.md5_commands';
  ...
  //------------------//
    ...
    public function m5_privileges() { return $this->belongsToMany('\M5\Models\MD3_privileges', 'm5.md2001', 'id_command', 'id_privilege'); }
    // relationships stop

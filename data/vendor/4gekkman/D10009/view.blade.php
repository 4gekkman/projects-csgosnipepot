...
Оглавление
  ...
  В. Зона для SEO-текста
    ...
    В2. Меню со ссылками на SEO-статьи
...
<!------------------------*/ ?>
  ...
  <!-- В2. Меню со ссылками на SEO-статьи -->
  <!------------------------------------*/ ?>
  <div class="seo-menu" data-bind="visible: layoutmodel.m.s1.selected_subdoc().uri() == '/' && m.s0.auth.is_anon()">

    <ul>
      <li><a href="/sitemap">Карта сайта</a></li>
      <li><a href="/prodazha-veshchej-cs-go">Моментальная продажа вещей</a></li>
      <li><a href="/skiny-i-ih-poleznost-v-igre">Скины</a></li>
      <li><a href="/randomnye-veshchi">Рандомные вещи</a></li>
      <li><a href="/vintovki">Винтовки</a></li>
      <li><a href="/stavki-skinov">Ставки на скины</a></li>
      <li><a href="/veshchi-v-counter-strike-global-offensive">Вещи</a></li>
      <li><a href="/pokupka-nozhej-v-cs-go">Покупка ножей</a></li>
      <li><a href="/nozhi-v-counter-strike">Ножи</a></li>
      <li><a href="/pokupka-oruzhiya">Покупай оружие в CS GO дешево!</a></li>
      <li><a href="/pistolety-v-cs-go">Покупка пистолетов</a></li>
      <li><a href="/obzor-pistoletov-cs-go">Обзор пистолетов</a></li>
      <li><a href="/ruletka-cs-go-dlya-bomzhej">Рулетка для бомжей</a></li>
      <li><a href="/server-veshchej-cs-go">Сервер вещей</a></li>
    </ul>

 ...
 *    f.s1.animate_bank_sum               | s1.29. Анимировать изменение суммы банка
 *
 */
...
var ModelFunctionsJackpot = { constructor: function(self, f) { f.s1 = this;
	...
	//------------------------------------------//
	// s1.29. Анимировать изменение суммы банка //
	//------------------------------------------//
	f.s1.animate_bank_sum = function(id_room) {

 		// 1] Получить ID соотв.элемента
		var id = '#game-prize-'+id_room;

		// 2] Получить элемент с id
		var e = $(id);

		// 3] Добавить класс bigred элементу e
		e.addClass('bigred');

		// 4] Через секунду удалить класс bigred у элемента e
		setTimeout(function(e){

			e.removeClass('bigred');

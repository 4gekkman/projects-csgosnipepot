...
// Консольная команда //
//--------------------//
class T16_getgroupprivs extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm5:getgroupprivs';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Get all group privileges';
  ...
  public function handle()
  {
    ...
    // 1. Спросить, для какой группы требуется получить права
    $id_group = $this->anticipate("[REQUIRED] ID of the group for which you want to get list of privileges", []);

    // 2. Выполнить команду
    $result = runcommand('\M5\Commands\C32_getgroupprivs', ['id' => $id_group]);

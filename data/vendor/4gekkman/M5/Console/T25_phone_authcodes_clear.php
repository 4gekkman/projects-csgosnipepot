...
// Консольная команда //
//--------------------//
class T25_phone_authcodes_clear extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm5:phone_authcodes_clear';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Clear table with auth codes from expired';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M5\Commands\C65_phone_authcodes_clear');

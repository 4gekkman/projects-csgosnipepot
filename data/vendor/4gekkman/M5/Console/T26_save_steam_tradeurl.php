...
// Консольная команда //
//--------------------//
class T26_save_steam_tradeurl extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm5:save_steam_tradeurl';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Public interface command to save users steam trade url';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M5\Commands\C70_save_steam_tradeurl', $this->argument());

...
// Консольная команда //
//--------------------//
class T17_email_cleartable extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm5:email_cleartable';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Delete from email verification table old codes (out of date)';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M5\Commands\C52_email_cleartable');

...
// Консольная команда //
//--------------------//
class T19_delnotverifiedemail extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm5:delnotverifiedemail';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Every hour check and del users with not verified emails if their time is expired';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M5\Commands\C54_delnotverifiedemail');

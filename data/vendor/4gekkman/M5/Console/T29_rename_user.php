...
// Консольная команда //
//--------------------//
class T29_rename_user extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm5:rename_user {id_user} {new_name}';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Rename specified by id user';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M5\Commands\C73_rename_user', $this->argument());

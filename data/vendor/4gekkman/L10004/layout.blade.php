...
<body>
  ...
  <div class="site-header">
    ...
    <div class="area1">
      ...
      <div class="logo">
        <img src="{!! asset('public/L10004/assets/images/main_logo.png') !!}">
      </div>
    ...
    <div class="items" data-bind="foreach: m.s1.subdocs">
      ...
      <div class="item" data-bind="style: {backgroundColor: bg_color, borderColor: brd_color}, css: {choosen: $data.uri() == $root.m.s1.selected_subdoc().uri()}, visible: visible">
        ...
        <div class="item-content">
          ...
          <!------------------------------------------*/ ?>
          <div style="display: none" data-bind="visible: ['/', '/support'].indexOf(uri()) == -1, click: function(){ window.location = uri(); }">

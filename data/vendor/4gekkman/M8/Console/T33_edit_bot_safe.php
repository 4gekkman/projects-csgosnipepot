...
// Консольная команда //
//--------------------//
class T33_edit_bot_safe extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm8:edit_bot_safe';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Edit safe bot properties';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M8\Commands\C36_edit_bot_safe', $this->argument());

...
// Консольная команда //
//--------------------//
class T15_update_prices_all extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm8:update_prices_all';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Updates prices from every source in DB';
  ...
  public function handle()
  {
     ...
     * Оглавление
     *
     *  1. Отправить в очередь задачу на обновление цен с csgofast
     *  2. Отправить в очередь задачу на обновление цен с Steam Market
     *
     */

    // 1. Отправить в очередь задачу на обновление цен с csgofast
    Artisan::queue('m8:update_prices_csgofast');

    // 2. Отправить в очередь задачу на обновление цен с Steam Market
    Artisan::queue('m8:update_prices_steammarket');

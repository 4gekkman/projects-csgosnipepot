...
// Консольная команда //
//--------------------//
class T13_get_price_steammarket extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm8:get_price_steammarket {name}';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Gets price of item with specified name using steamcommunity priceoverview';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M8\Commands\C16_get_price_steammarket', $this->argument());

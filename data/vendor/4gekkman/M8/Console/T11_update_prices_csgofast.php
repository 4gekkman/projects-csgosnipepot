...
// Консольная команда //
//--------------------//
class T11_update_prices_csgofast extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm8:update_prices_csgofast';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Gets prices from csgofast and updates local DB of items and prices';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M8\Commands\C14_update_prices_csgofast', $this->argument());

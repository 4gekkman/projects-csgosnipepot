...
// Консольная команда //
//--------------------//
class T3_bot_get_mobile_code extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm8:bot_get_mobile_code {id_bot} {time=0}';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Get mobile authentication code for specified bot and time.';

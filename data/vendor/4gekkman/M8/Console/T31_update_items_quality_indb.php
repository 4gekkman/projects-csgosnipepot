 ...
 *  Что делает
 *  ----------
 *    - Foreach thought all items in m8 db and update their quality and images from steamcommunity
 *
 *  Аргументы
 *  ---------
 *
...
// Консольная команда //
//--------------------//
class T31_update_items_quality_indb extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm8:update_items_quality_indb';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Foreach thought all items in m8 db and update their quality and images from steamcommunity';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M8\Commands\C33_update_items_quality_indb', $this->argument());

 ...
 *         -----
 *
 *           1] routes      | 1:n прямая            | С какими роутами связан этот тип
 *
...
// В. Класс-модель //
//-----------------//
class MD2_types extends Model { // implements ModelInterface
  ...
  //------------------//
    ...
    //-------//
      ...
      //-----------//
      // - 1:n прямая
      // - С какими роутами связан этот тип
      public function routes()
      {
        return $this->hasMany('\M4\Models\MD1_routes', 'id_type', 'id');
      }

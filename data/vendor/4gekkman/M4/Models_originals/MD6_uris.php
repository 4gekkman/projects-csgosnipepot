 ...
 *         -----
 *
 *           1] routes      | n:m          | С какими роутами связан этот uri
 *
...
// В. Класс-модель //
//-----------------//
class MD6_uris extends Model { // implements ModelInterface
  ...
  //------------------//
    ...
    //-------//
      ...
      //-----------//
      // - n:m
      // - С какими роутами связан этот uri
      public function routes()
      {
        return $this->belongsToMany('\M4\Models\MD1_routes', 'm4.md1003', 'id_uri', 'id_route');
      }

 ...
 *         -----
 *
 *           1] routes      | n:m          | С какими роутами связан этот протокол
 *
...
// В. Класс-модель //
//-----------------//
class MD4_protocols extends Model { // implements ModelInterface
  ...
  //----------------------//
    ...
    // - Внимание! Регистр в имени таблицы имеет значение!
      ...
      protected $table = 'm4.md4_protocols';
  ...
  //------------------//
    ...
    //-------//
      ...
      //-----------//
      // - n:m
      // - С какими роутами связан этот протокол
      public function routes()
      {
        return $this->belongsToMany('\M4\Models\MD1_routes', 'm4.md1001', 'id_protocol', 'id_route');
      }

...
// Консольная команда //
//--------------------//
class T1_parse_faq extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm12:parse_faq';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Parse FAQ data from its root folder to M12 database';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M12\Commands\C1_parse_faq', $this->argument());

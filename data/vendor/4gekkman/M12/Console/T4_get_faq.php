...
// Консольная команда //
//--------------------//
class T4_get_faq extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm12:get_faq';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Get FAQ data';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M12\Commands\C4_get_faq', $this->argument());

...
// Консольная команда //
//--------------------//
class T1_get_status extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm15:get_status';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Get user status if he already got free coins today';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M15\Commands\C1_get_status', $this->argument());

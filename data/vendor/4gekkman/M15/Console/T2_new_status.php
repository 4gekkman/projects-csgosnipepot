...
// Консольная команда //
//--------------------//
class T2_new_status extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm15:new_status {id_user} {force}';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Create new status for specified user';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M15\Commands\C2_new_status', $this->argument());

...
// Консольная команда //
//--------------------//
class T5_get_time_until_next_day extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm15:get_time_until_next_day';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Get time that is left until the next day 00 00 utc';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M15\Commands\C5_get_time_until_next_day', $this->argument());

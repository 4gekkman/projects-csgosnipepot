...
// Консольная команда //
//--------------------//
class T3_get_freecoins extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm15:get_freecoins {id_user}';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Give free coins to specified user if he is not have already gotten it today';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M15\Commands\C3_get_freecoins', $this->argument());

...
// Консольная команда //
//--------------------//
class T4_get_counters_data extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm16:get_counters_data {id_user=0}';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Get counters and config data';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M16\Commands\C4_get_counters_data', $this->argument());

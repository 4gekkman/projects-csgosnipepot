...
// Консольная команда //
//--------------------//
class T8_active_offers_tracking extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm16:active_offers_tracking';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M16\Commands\C8_active_offers_tracking', $this->argument());

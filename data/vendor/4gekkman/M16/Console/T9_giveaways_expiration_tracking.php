...
// Консольная команда //
//--------------------//
class T9_giveaways_expiration_tracking extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm16:giveaways_expiration_tracking';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Tracking of giveaways expiration';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M16\Commands\C9_giveaways_expiration_tracking', $this->argument());

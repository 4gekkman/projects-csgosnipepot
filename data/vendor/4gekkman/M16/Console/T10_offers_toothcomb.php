...
// Консольная команда //
//--------------------//
class T10_offers_toothcomb extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm16:offers_toothcomb';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Looking in steam information about active offers in the system and write it down to cache';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M16\Commands\C10_offers_toothcomb', $this->argument());

...
// Консольная команда //
//--------------------//
class T11_create_giveaway_offer extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm16:create_giveaway_offer';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Create giveaway offer and drop online counter of the user';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M16\Commands\C11_create_giveaway_offer', $this->argument());

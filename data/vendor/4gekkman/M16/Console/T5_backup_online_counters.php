...
// Консольная команда //
//--------------------//
class T5_backup_online_counters extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm16:backup_online_counters';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Backup and restore online counters after server reboot';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M16\Commands\C5_backup_online_counters', $this->argument());

...
// Консольная команда //
//--------------------//
class T20_update_history_cache extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm9:update_history_cache';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M9\Commands\C51_update_history_cache', $this->argument());

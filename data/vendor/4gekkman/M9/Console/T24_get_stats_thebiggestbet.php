...
// Консольная команда //
//--------------------//
class T24_get_stats_thebiggestbet extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm9:get_stats_thebiggestbet {force} {broadcast}';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Get stats the biggest bet and update cache if needed';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M9\Commands\C55_get_stats_thebiggestbet', $this->argument());

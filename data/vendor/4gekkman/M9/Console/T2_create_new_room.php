...
// Консольная команда //
//--------------------//
class T2_create_new_room extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm9:create_new_room {name}';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Create a new game room';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M9\Commands\C2_create_new_room', $this->argument());

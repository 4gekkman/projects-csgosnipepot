...
class C11_processor extends Job { // TODO: добавить "implements ShouldQueue" - и команда будет добавляться в очередь задач
  ...
  public function handle()
  {
     ...
     *  Г. Отслеживать изменение статусов текущих раундов всех вкл.комнат, обеспечивать наличие "Created"-раунда
     *    Г1. Отслеживать статусы раунда
     *    Г2. Обеспечивать наличие свежего-не-finished раунда в каждой вкл.комнате

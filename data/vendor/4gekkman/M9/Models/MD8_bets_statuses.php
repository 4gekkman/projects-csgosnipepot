...
// В. Класс-модель //
//-----------------//
class MD8_bets_statuses extends Model {
  ...
  protected $table = 'm9.md8_bets_statuses';
  ...
  //------------------//
    ...
    // relationships start
    public function bets() { return $this->belongsToMany('\M9\Models\MD3_bets', 'm9.md1011', 'id_status', 'id_bet')->withPivot(['expired_at']); }
    // relationships stop

...
// Консольная команда //
//--------------------//
class T2_add_message_to_the_room extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm10:add_message_to_the_room {id_room} {message} {from_who_id=0}';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Add specified message to the specified room';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M10\Commands\C2_add_message_to_the_room', $this->argument());

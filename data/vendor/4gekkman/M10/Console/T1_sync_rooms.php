...
// Консольная команда //
//--------------------//
class T1_sync_rooms extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm10:sync_rooms';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Sync rooms with the settings from config';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M10\Commands\C1_sync_rooms', $this->argument());

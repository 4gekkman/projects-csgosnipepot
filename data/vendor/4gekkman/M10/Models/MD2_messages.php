...
// В. Класс-модель //
//-----------------//
class MD2_messages extends Model {
  ...
  protected $table = 'm10.md2_messages';
  ...
  //------------------//
    ...
    // relationships start
    public function rooms() { return $this->belongsToMany('\M10\Models\MD1_rooms', 'm10.md1000', 'id_message', 'id_room'); }
    public function m5_users() { return $this->belongsToMany('\M5\Models\MD1_users', 'm10.md2001', 'id_message', 'id_user'); }
    // relationships stop
  ...
  //-----------------------------------------//
    ...
    //-----------------------------//
      ...
      //{
      //  return $this->hasMany('\M10\Models\MD2_y', 'id_y', 'id');
      //}
      ...
      //{
      //  return $this->belongsTo('\M10\Models\MD1_x', 'id_y', 'id');
      //}
      ...
      //{
      //  return $this->belongsToMany('\M10\Models\MD3_a', 'm10.md1000', 'id_b', 'id_a');
      //}

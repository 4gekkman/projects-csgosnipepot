 ...
 *         -----
 *
 *           1] package       | m:n                 | С каким пакетом связана эта команда
 *
 ...
 */
  ...
  // В. Класс-модель //
  //-----------------//
  class MD5_commands extends Model { // implements ModelInterface
    ...
    //------------------//
      ...
      //-------//
        ...
        {
          return $this->belongsToMany('\M1\Models\MD2_packages', 'm1.md1003', 'id_command', 'id_package');
        }

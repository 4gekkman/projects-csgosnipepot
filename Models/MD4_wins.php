...
class MD4_wins extends Model {
  ...
  //------------------//
    ...
    public function wins_statuses() { return $this->belongsToMany('\M9\Models\MD9_wins_statuses', 'm9.md1012', 'id_win', 'id_status')->withPivot(['started_at','comment']); }
    ...
    public function m8_bots() { return $this->belongsToMany('\M8\Models\MD1_bots', 'm9.md2005', 'id_win', 'id_bot')->withPivot(['is_free','tradeofferid','offer_expired_at']); }

...
// В. Класс-модель //
//-----------------//
class MD1_statuses extends Model {
  ...
  protected $table = 'm15.md1_statuses';
  ...
  //------------------//
    ...
    // relationships start
    public function history() { return $this->belongsToMany('\M15\Models\MD2_history', 'm15.md1000', 'md1_statuses_id', 'md2_history_id')->withPivot(['md1_statuses_id','md2_history_id']); }
    public function m5_users() { return $this->belongsToMany('\M5\Models\MD1_users', 'm15.md2000', 'id_status', 'id_user'); }
    // relationships stop
  ...
  //-----------------------------------------//
    ...
    //-----------------------------//
      ...
      //{
      //  return $this->hasMany('\M15\Models\MD2_y', 'id_y', 'id');
      //}
      ...
      //{
      //  return $this->belongsTo('\M15\Models\MD1_x', 'id_y', 'id');
      //}
      ...
      //{
      //  return $this->belongsToMany('\M15\Models\MD3_a', 'm15.md1000', 'id_b', 'id_a');
      //}

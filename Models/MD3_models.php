 ...
 *         -----
 *
 *           1] package   | n:m                 | Пакет, которому принадлежит модель
 *
 ...
 */
  ...
  // В. Класс-модель //
  //-----------------//
  class MD3_models extends Model { // implements ModelInterface
    ...
    //------------------//
      ...
      //-------//
        ...
        //------------//
        // - m:n
        // - Пакет, которому принадлежит модель
        public function package()
        {
          return $this->belongsToMany('\M1\Models\MD2_packages', 'm1.md1001', 'id_model', 'id_package');
        }

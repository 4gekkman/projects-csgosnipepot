...
// В. Класс-модель //
//-----------------//
class MD8_packages extends Model {
  ...
  //------------------//
    ...
    // relationships start
    public function routes() { return $this->belongsToMany('\M4\Models\MD1_routes', 'm4.md1004', 'id_package', 'id_route'); }
    public function packtypes() { return $this->belongsTo('\M4\Models\MD7_packtypes', 'id_packtype', 'id'); }
    // relationships stop

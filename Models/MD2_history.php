...
// В. Класс-модель //
//-----------------//
class MD2_history extends Model {
  ...
  protected $table = 'm15.md2_history';
  ...
  //------------------//
    ...
    // relationships start
    public function statuses() { return $this->belongsToMany('\M15\Models\MD1_statuses', 'm15.md1000', 'md2_history_id', 'md1_statuses_id')->withPivot(['md1_statuses_id','md2_history_id']); }
    // relationships stop

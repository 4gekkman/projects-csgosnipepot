 ...
 *         -----
 *
 *           1] package       | m:n                 | С каким пакетом связана эта консольная команда
 *
 ...
 */
  ...
  // В. Класс-модель //
  //-----------------//
  class MD6_console extends Model { // implements ModelInterface
    ...
    //----------------------//
      ...
      // - Внимание! Регистр в имени таблицы имеет значение!
        ...
        protected $table = 'm1.md6_console';
    ...
    //------------------//
      ...
      //-------//
        ...
        //------------//
        // - m:n
        // - С каким документом связана эта команда
        public function package()
        {
          return $this->belongsToMany('\M1\Models\MD2_packages', 'm1.md1004', 'id_console', 'id_package');
        }

 ...
 *         -----
 *
 *           1] package       | m:n                 | С каким пакетом связан этот обработчик
 *
 ...
 */
  ...
  // В. Класс-модель //
  //-----------------//
  class MD7_handlers extends Model { // implements ModelInterface
    ...
    //------------------//
      ...
      //-------//
        ...
        {
          return $this->belongsToMany('\M1\Models\MD2_packages', 'm1.md1005', 'id_handler', 'id_package');
        }

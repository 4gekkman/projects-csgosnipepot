...
// В. Класс-модель //
//-----------------//
class MD3_articles extends Model {
  ...
  protected $table = 'm12.md3_articles';
  ...
  //------------------//
    ...
    // relationships start
    public function groups() { return $this->belongsToMany('\M12\Models\MD2_groups', 'm12.md1001', 'id_article', 'id_group'); }
    public function countrycode() { return $this->belongsToMany('\M12\Models\MD4_countrycode', 'm12.md1002', 'id_article', 'id_countrycode'); }
    // relationships stop
  ...
  //-----------------------------------------//
    ...
    //-----------------------------//
      ...
      //{
      //  return $this->hasMany('\M12\Models\MD2_y', 'id_y', 'id');
      //}
      ...
      //{
      //  return $this->belongsTo('\M12\Models\MD1_x', 'id_y', 'id');
      //}
      ...
      //{
      //  return $this->belongsToMany('\M12\Models\MD3_a', 'm12.md1000', 'id_b', 'id_a');
      //}

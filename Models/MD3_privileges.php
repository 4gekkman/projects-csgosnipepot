...
// В. Класс-модель //
//-----------------//
class MD3_privileges extends Model {
  ...
  protected $table = 'm5.md3_privileges';
  ...
  //------------------//
    ...
    // relationships start
    public function groups() { return $this->belongsToMany('\M5\Models\MD2_groups', 'm5.md1003', 'id_privilege', 'id_group'); }
    public function users() { return $this->belongsToMany('\M5\Models\MD1_users', 'm5.md1004', 'id_privilege', 'id_user'); }
    public function tags() { return $this->belongsToMany('\M5\Models\MD4_tags', 'm5.md1007', 'id_privilege', 'id_tag'); }
    public function privtypes() { return $this->belongsTo('\M5\Models\MD5_privtypes', 'id_privtype', 'id'); }
    public function m1_packages() { return $this->belongsToMany('\M1\Models\MD2_packages', 'm5.md2000', 'id_privilege', 'id_package'); }
    public function m1_commands() { return $this->belongsToMany('\M1\Models\MD5_commands', 'm5.md2001', 'id_privilege', 'id_command'); }
    // relationships stop

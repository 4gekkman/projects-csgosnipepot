 ...
 *         -----
 *
 *           1] dependencies    | m:n                 | От каких пакетов зависит данный пакет
 *           2] locales         | m:n                 | Какие локали поддерживает данный пакет
 *           3] locale          | m:n                 | Какая локаль выбрана для этого пакета
 *           4] packtype        | 1:n обратная        | Тип этого пакета
 *           5] models          | m:n                 | Какие модели принадлежат пакету
 *           6] commands        | m:n                 | С какими командами связан этот пакет
 *           7] consoles        | m:n                 | С какими консольными командами связан этот пакет
 *           8] handlers        | m:n                 | С какими обработчиками связан этот пакет
 *
 ...
 */
  ...
  //-------------------------------------//
    ...
    // Контракт модели
    //use M1\Contracts\_CT1_MD1_sample;

  //-----------------//
  // В. Класс-модель //
  //-----------------//
  class MD2_packages extends Model { // implements ModelInterface
    ...
    //----------------------//
      ...
      // - Внимание! Регистр в имени таблицы имеет значение!
        ...
        protected $table = 'm1.md2_packages';
    ...
    //------------------//
      ...
      //-------//
        ...
        //-----------------//
        // - m:n
        // - От каких пакетов зависит данный пакет
        public function dependencies()
        {
          return $this->belongsToMany('\M1\Models\MD2_packages', 'm1.md1000', 'id_package1', 'id_package2');
        }

        // 2] locales //
        //------------//
        // - m:n
        // - Какие локали поддерживает данный пакет
        public function locales()
        {
          return $this->belongsToMany('\M1\Models\MD4_locales', 'm1.md1002', 'id_package', 'id_locale');
        }

        // 3] locale //
        //-----------//
        // - m:n
        // - Какая локаль выбрана для этого пакета
        public function locale()
        {
          return $this->belongsToMany('\M1\Models\MD4_locales', 'm1.md1006', 'id_package', 'id_locale');
        }
        ...
        {
          return $this->belongsTo('\M1\Models\MD1_packtypes', 'id_packtype', 'id');
        }

        // 5] models //
        //-----------//
        // - m:n
        // - Какие модели принадлежат пакету
        public function models()
        {
          return $this->belongsToMany('\M1\Models\MD3_models', 'm1.md1001', 'id_package', 'id_model');
        }

        // 6] commands //
        //-------------//
        // - m:n
        // - С какими командами связан этот пакет
        public function commands()
        {
          return $this->belongsToMany('\M1\Models\MD5_commands', 'm1.md1003', 'id_package', 'id_command');
        }
        ...
        {
          return $this->belongsToMany('\M1\Models\MD6_console', 'm1.md1004', 'id_package', 'id_console');
        }

        // 8] handlers //
        //-------------//
        // - m:n
        // - С какими обработчиками связан этот пакет
        public function handlers()
        {
          return $this->belongsToMany('\M1\Models\MD7_handlers', 'm1.md1005', 'id_package', 'id_handler');
        }

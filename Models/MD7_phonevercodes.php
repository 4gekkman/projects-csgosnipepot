...
// В. Класс-модель //
//-----------------//
class MD7_phonevercodes extends Model {
  ...
  protected $table = 'm5.md7_phonevercodes';
  ...
  //------------------//
    ...
    // relationships start
    public function users() { return $this->belongsToMany('\M5\Models\MD1_users', 'm5.md1009', 'id_code', 'id_user'); }
    // relationships stop

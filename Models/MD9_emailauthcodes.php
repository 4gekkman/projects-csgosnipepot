...
// В. Класс-модель //
//-----------------//
class MD9_emailauthcodes extends Model {
  ...
  protected $table = 'm5.md9_emailauthcodes';
  ...
  //------------------//
    ...
    // relationships start
    public function users() { return $this->belongsToMany('\M5\Models\MD1_users', 'm5.md1011', 'id_code', 'id_user'); }
    // relationships stop

...
// В. Класс-модель //
//-----------------//
class MD7_groups extends Model {
  ...
  //------------------//
    ...
    // relationships start
    public function bots() { return $this->belongsToMany('\M8\Models\MD1_bots', 'm8.md1004', 'id_group', 'id_bot'); }
    public function tasks() { return $this->belongsToMany('\M8\Models\MD8_tasks', 'm8.md1005', 'id_group', 'id_task'); }
    // relationships stop
  ...
  //-----------------------------------------//
    ...
    //-----------------------------//
      ...
      //{
      //  return $this->hasMany('\M8\Models\MD2_y', 'id_y', 'id');
      //}
      ...
      //{
      //  return $this->belongsTo('\M8\Models\MD1_x', 'id_y', 'id');
      //}
      ...
      //{
      //  return $this->belongsToMany('\M8\Models\MD3_a', 'm8.md1000', 'id_b', 'id_a');
      //}

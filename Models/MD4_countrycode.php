...
// В. Класс-модель //
//-----------------//
class MD4_countrycode extends Model {
  ...
  protected $table = 'm12.md4_countrycode';
  ...
  //------------------//
    ...
    // relationships start
    public function articles() { return $this->belongsToMany('\M12\Models\MD3_articles', 'm12.md1002', 'id_countrycode', 'id_article'); }
    // relationships stop

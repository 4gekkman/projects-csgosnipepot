...
// В. Класс-модель //
//-----------------//
class MD3_operation_types extends Model {
  ...
  protected $table = 'm13.md3_operation_types';
  ...
  //------------------//
    ...
    // relationships start
    public function history() { return $this->belongsToMany('\M13\Models\MD2_history', 'm13.md1001', 'id_operation_types', 'id_history'); }
    // relationships stop

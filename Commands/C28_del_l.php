...
// Команда //
//---------//
class C28_del_l extends Job { // TODO: добавить "implements ShouldQueue" - и команда будет добавляться в очередь задач
  ...
  public function handle()
  {
     ...
     *  2. Проверить существование L-пакета $packid
     *  3. Удалить каталог L-пакета $packid
     *  4. Удалить пр.имён L-пакета из composer.json проекта -> autoload -> psr-4
     *  5. Удалить файл-конфиг L-пакета (если требуется)

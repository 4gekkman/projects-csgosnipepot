...
class C20_del_m extends Job { // TODO: добавить "implements ShouldQueue" - и команда будет добавляться в очередь задач
  ...
  public function handle()
  {
     ...
     *  3. Удалить каталог M-пакета $packid
     *  4. Удалить пр.имён M-пакета из composer.json проекта -> autoload -> psr-4
     *  5. Удалить файл-конфиг M-пакета (если требуется)
     *  6. Удалить БД пакета (если требуется)

...
// Команда //
//---------//
class C12_newtag extends Job { // TODO: добавить "implements ShouldQueue" - и команда будет добавляться в очередь задач
  ...
  public function handle()
  {
    ...
    $res = call_user_func(function() { try { DB::beginTransaction();
      ...
      return [
        ...
        $errortext = 'Invoking of command C12_newtag from M-package M5 have ended with error: '.$e->getMessage();
        DB::rollback();
        Log::info($errortext);

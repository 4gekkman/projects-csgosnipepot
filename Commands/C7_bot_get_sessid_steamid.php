...
// Команда //
//---------//
class C7_bot_get_sessid_steamid extends Job { // TODO: добавить "implements ShouldQueue" - и команда будет добавляться в очередь задач
  ...
  public function handle()
  {
    ...
    //--------------------------------------------------//
    // Получить steamid и sessionid для указанного бота //
    //--------------------------------------------------//
    $res = call_user_func(function() { try {
      ...
      return [
        ...
        $errortext = 'Invoking of command C7_bot_get_sessid_steamid from M-package M8 have ended on line "'.$e->getLine().'" on file "'.$e->getFile().'" with error: '.$e->getMessage();
        Log::info($errortext);
        write2log($errortext, ['M8', 'C7_bot_get_sessid_steamid']);
        return [
          "status"  => -2,
          "data"    => [
            "errortext" => $errortext,

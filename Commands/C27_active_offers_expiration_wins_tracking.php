 ...
 *  Что делает
 *  ----------
 *    - Active offers (wins) expiration tracking
 *
...
// Команда //
//---------//
class C27_active_offers_expiration_wins_tracking extends Job { // TODO: добавить "implements ShouldQueue" - и команда будет добавляться в очередь задач
  ...
  public function handle()
  {
    ...
    DB::commit(); } catch(\Exception $e) {
        ...
        DB::rollback();
        Log::info($errortext);
        write2log($errortext, ['M9', 'C27_active_offers_expiration_wins_tracking']);
        return [
          "status"  => -2,
          "data"    => [
            "errortext" => $errortext,

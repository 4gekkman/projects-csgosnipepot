 ...
 *  Что делает
 *  ----------
 *    - Create new remote repo in github for MDLWR-pack
 *
...
// Команда //
//---------//
class C52_github_new_remote extends Job { // TODO: добавить "implements ShouldQueue" - и команда будет добавляться в очередь задач

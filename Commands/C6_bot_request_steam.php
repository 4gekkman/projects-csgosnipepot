 ...
 *    [
 *      "data" => [
 *        url       // Куда осуществлять запрос
 *        mobile    // Имитировать ли запрос с мобильного устройства (true/false)
...
class C6_bot_request_steam extends Job { // TODO: добавить "implements ShouldQueue" - и команда будет добавляться в очередь задач
  ...
  public function handle()
  {
    ...
    //----------------------------------------------------------------//
    // Отправить запрос в Steam по url от лица бота, имитируя браузер //
    //----------------------------------------------------------------//

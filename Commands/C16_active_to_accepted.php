...
class C16_active_to_accepted extends Job { // TODO: добавить "implements ShouldQueue" - и команда будет добавляться в очередь задач
  ...
  public function handle()
  {
     ...
     *  10. Обновить статистику "Наибольшая ставка" и транслировать всем клиентам через публичный канал
     *  11. Обновить статистику "Счастливчик дня" и транслировать всем клиентам через публичный канал
     *
     *  N. Вернуть статус 0
     *
     */

...
class C31_add_new_bot extends Job { // TODO: добавить "implements ShouldQueue" - и команда будет добавляться в очередь задач
  ...
  public function handle()
  {
    ...
    $res = call_user_func(function() { try { DB::beginTransaction();
      ...
      // 4. Добавить этого пользователя в группы Steam-юзеров и Steam-ботов (их названия брать из конфига)

      // 5. Обновить ботов в клиенте, что вызовет авто.синхронизацию таблицы ботов с пользователями

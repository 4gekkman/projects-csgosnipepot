 ...
 *  Что делает
 *  ----------
 *    - Turn on / Turn off the system access restrictions
 *
...
// Команда //
//---------//
class C2_switch extends Job { // TODO: добавить "implements ShouldQueue" - и команда будет добавляться в очередь задач
  ...
  public function handle()
  {
    ...
    //-----------------------------------------------------------------------//
    // Переключить значение опции пакета M5 "common_ison" на противоположное //
    //-----------------------------------------------------------------------//
    ...
    DB::commit(); } catch(\Exception $e) {
        ...
        DB::rollback();
        Log::info($errortext);
        write2log($errortext, ['M5', 'C2_switch']);
        return [
          "status"  => -2,
          "data"    => $errortext
        ];

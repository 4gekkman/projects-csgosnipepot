...
# Система управления фронтендом им. 4gekkman'а для laravel-приложения
  ...
  ▪ Термин "фронтенд"
    ...
    - В дальнейшем, при упоминании этих составляющих, будем иметь в виду описанное.

  ▪ Composer & Bower
    - У вендора 4gekkman есть 2 типа пакетов: composer и bower.
    - Рассмотрим их подробнее в свете СУФ:

      ▪ Composer-пакеты
        - Это пакеты для применения в php/laravel среде.
        - Упомянутые DLW-пакеты являются composer-пакетами.
        - D-пакеты содержат laravel-документы.
        - L-пакеты содержат laravel-шаблоны.
        - W-пакеты содержат laravel-виджеты.
        - Composer-пакеты могут древообразно зависеть друг от друга.

      ▪ Bower-пакеты
        - Это пакеты для работы с фронтендом.
        - Они могут зависить друг от друга, и имеют плоский стек зависимостей.

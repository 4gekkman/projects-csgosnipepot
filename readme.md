...
# Какие типы пакетов бывают у вендора 4gekkman
  ...
  • P-пакет
    - Это пакет для фронтенд-ресурсов.
    - Он оформлен одновременно, как composer-, и как bower-пакет.
    - Может содержать ресурсы, подключаемые через фронтенд-составляющую приложения.
...
# Возможные взаимные схемы зависимостей для пакетов разных типов
  ...
  • Бэкенд-зависимости прописываются в composer.json пакета
    - M,D,L,W,P-пакеты содержат и composer.json, и bower.json.
    - Все бэкенд-зависимости прописываются в composer.json.
    - В стандартном для этого св-ве require.
  ...
  • Фронтенд-зависимости прописываются в bower.json пакета
    ...
    - В стандартном для этого св-ве dependencies.
  ...
  • Допустимые схемы зависимостей для пакетов разных типов
    ...
    ▪ D <--- M,L,W,P
      ...
      - И, разумеется, использовать фронтенд-ресурсы из P-пакетов.
    ...
    ▪ P <--- P
      - И, разумеется, P-пакеты с фронтенд-ресурсами.
      - Которые являются bower-пакетами, могут зависеть друг от друга.

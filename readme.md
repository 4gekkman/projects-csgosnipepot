...
# Система управления фронтендом им. 4gekkman'а для laravel-приложения
  ...
  > Б2. Механика СУФ
    ...
    • Сбор всех dependencies bower.json проекта
      - Обход всех bower.json DLW-пакетов.
      - Сбор всех уникальных значений в dependencies главного bower.json

    • install/prune/update пакетов из главного bower.json проекта
      - Сабж.

    • Сбор всех main в главный bower.json проекта
    ...
    • Подмена main некоторых пакетов в главном bower.json проекта
    ...
    • Сбор всех конфигов компиляции/обработки/публикации всех DLW-пакетов
      - Обход всех bower.json всех bower-пакетов в public/public/bower
    ...
    • Компиляция/обработка/публикация public-ресурсов DLW-пакетов

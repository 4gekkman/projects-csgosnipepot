...
# Система управления фронтендом им. 4gekkman'а для laravel-приложения
  ...
  Подоглавление:
    ...
    А.  Теоретические основы СУФ
      ...
      А8. Куда и как публикуется фронтенд из источников

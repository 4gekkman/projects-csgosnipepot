...
## Оглавление
  ...
  - [Прикладные инструкции по работе с СУБ и СУФ](#link5)
	...
	- [Стратегия продажи и сервиса проектов](#link9)
...
## Стратегия продажи и сервиса проектов <a id="link9"></a>
```
---------------------------------------
Подоглавление:
...
//-------------------------------//
  ...
  • Для всех проектов стараемся использовать одни и те же MR-пакеты
    - Потому что в большинстве случаев в них от проекта к проекну ничего не надо менять.

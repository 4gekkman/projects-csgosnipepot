...
```
  ...
  # Авторизация: проверка access-прав в C66_authorize_access в контроллерах DLW-пакетов
    ...
    • Команда C66_authorize_access
      ...
      - Сначала authorize_access проверяет ID пользователя. Если это -1 или не 0/целое полож.число,
        то доступ запрещён, и команда возвращает статус 1.
        Если это 0, то команда сразу возвращает статус 0 без проверки прав (режим бога).

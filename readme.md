  ...
  • Файловая структура СУФ
    ...
    <проект>                                | Каталог всего docker-проекта (не путать с каталогом project с laravel-проектом)
      ...
      /frontend                             | Каталог с основной частью файлов для СУФ (за исключением команд из M1)
        ...
        /bower_components_structured        | Задачи из /gulptasks размещают здесь bower-пакеты из /bower_components, структурированные по заданному формату
          /component1                       |
          /component2                       |
            /src                            | Здесь хранятся не обработанные исходники bower-пакета
              /css                          | CSS-исходники
                <имя1>.css                  |
                <имя2>.css                  |
                <имя3>.scss                 |
            ...
            /dist                           | Здесь хранятся обработанные, готовые к подключению JS/CSS пакета
              ...
              /js                           |
                j.js                        |
                j.min.js                    |
              /assets                       | // эти 3 папки олицетворяют всякие assets, которые могут быть в dist.
              /some_other_assets            | // Обычно они лежат в папках dist bower-пакетов, это могут быть /img, /fonts и т.д
              /else_assets                  | // Их нельзя перемещать относ. css/js, т.к. в оных указаны относ.пути к assets.
      ...
      /project                              | Это каталог с laravel-проектом
        ...
        /public                             | Это каталог с публичными ресурсами проекта
          ...
          /public                           | Это создаёт URI-сегмент для публ.ресурсов: http://site.ru/public/...
            ...
            /docs                           | Здесь публичные ресурсы bower-пакетов (dist)
              /D<id1 пакета>                |
              /D<id2 пакета>                |
                /dist                       |
                  /css                      |

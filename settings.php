...
return [
    ...
    'aboutpack' => [
      'RU' => [
        'name'        => 'CSGOHAP dashboard skins shop',
        'description' => 'CSGOHAP dashboard skins shop',
      ],
      'EN' => [
        'name'        => 'CSGOHAP dashboard skins shop',
        'description' => 'CSGOHAP dashboard skins shop',
    ...
    //-------------------------//
    // 5] Настройки D10012     //
    //    D10012 configuration //
    //-------------------------//

      // 5.1] MIN цена скинов на заказ в центах | MIN price for skins to order in cents
      'skins2order_min_price_cents' => 15000,

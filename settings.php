...
return [
    ...
    //-------------------------------------------------------------//
    'faq_root_folder'    => "vendor/4gekkman/R6/faq",

    //----------------------------------------------------------//
    // 6] Путь к папке, куда сохранять публичные ресурсы FAQ    //
    //    The path to folder where to save public FAQ resources //
    //----------------------------------------------------------//
    'public_faq_folder'    => "public/public/faq",

    //-----------------------------------------//
    // 7] Имя стартовой группы для каждого FAQ //
    //    The start group name for each FAQ    //
    //-----------------------------------------//
    // - Пример значения: 'csgohap' => 'cats'
    'start_group_names'    => [

...
// Консольная команда //
//--------------------//
class T34_set_bot_secrets extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm8:set_bot_secrets';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Update and crypt unsafe bot properties';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M8\Commands\C37_set_bot_secrets', $this->argument());

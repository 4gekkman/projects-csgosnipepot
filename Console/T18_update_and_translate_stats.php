...
// Консольная команда //
//--------------------//
class T18_update_and_translate_stats extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm9:update_and_translate_stats';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Update and translate game statistics through public websocket channel';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M9\Commands\C49_update_and_translate_stats', $this->argument());

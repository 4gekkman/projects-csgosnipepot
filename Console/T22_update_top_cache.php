...
// Консольная команда //
//--------------------//
class T22_update_top_cache extends Command
{
  ...
  //-----------------------------//
    ...
    protected $description = 'Updates TOP players cache';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M9\Commands\C53_update_top_cache', $this->argument());

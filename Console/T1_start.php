...
// Консольная команда //
//--------------------//
class T1_start extends Command
{
  ...
  public function handle()
  {
    ...
    $result = runcommand('\M11\Commands\C1_start', $this->argument());
    ...
    // 3. В случае успеха, вывести соотв.сообщение
    $this->comment("There is no ticks chain yet.");
    $this->info("The new chain of ticks has been successfully started.");

 ...
 *  Что делает
 *  ----------
 *    - Publish all resources of packages of this system
 *
 *  Аргументы
 *  ---------
 *
...
//-----------------------------------//
// - Пример для админ.документов:  M1\Documents\Main\Console
...
// Консольная команда //
//--------------------//
class T3_allrespublish extends Command
{
  ...
  // - TODO: указать шаблон консольной команды

    protected $signature = 'm1:allrespublish';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//
  // - TODO: написать описание консольной команды на eng

    protected $description = 'Publish all resources of packages of this system.';

...
// Консольная команда //
//--------------------//
class T23_auth_clear_expired extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm5:auth_clear_expired';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'This command every 24 hours delete expired auth notes from auth table';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M5\Commands\C60_auth_clear_expired');

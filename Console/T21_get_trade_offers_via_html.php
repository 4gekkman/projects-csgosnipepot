...
// Консольная команда //
//--------------------//
class T21_get_trade_offers_via_html extends Command
{
  ...
  //-----------------------------//
    ...
    protected $description = 'Get trade offers via get request to proper steam page and getting html';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M8\Commands\C24_get_trade_offers_via_html', $this->argument());

...
// Консольная команда //
//--------------------//
class T19_suf_check_deps extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm1:suf_check_deps';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Every used bower-pack in app must have corresponding data in R5, this command looks for bower-packs that does not.';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M1\Commands\C41_suf_check_deps');

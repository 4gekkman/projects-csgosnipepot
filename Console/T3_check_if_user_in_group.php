...
// Консольная команда //
//--------------------//
class T3_check_if_user_in_group extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm18:check_if_user_in_group {steamid}';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Check if user in group';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M18\Commands\C3_check_if_user_in_group', $this->argument());

...
// Консольная команда //
//--------------------//
class T12_update_prices_steammarket extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm8:update_prices_steammarket';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Gets prices from Steam Market and updates local DB of items and prices';

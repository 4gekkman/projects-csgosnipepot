...
// Консольная команда //
//--------------------//
class T5_clear_expired_or_extra_messages extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm10:clear_expired_or_extra_messages';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Clear expired or extra messages from chat rooms';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M10\Commands\C5_clear_expired_or_extra_messages', $this->argument());

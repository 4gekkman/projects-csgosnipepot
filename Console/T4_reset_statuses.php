...
// Консольная команда //
//--------------------//
class T4_reset_statuses extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm15:reset_statuses';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Reset statuses of all users to zero';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M15\Commands\C4_reset_statuses', $this->argument());

...
// Консольная команда //
//--------------------//
class T18_phone_cleartable extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm5:phone_cleartable';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Delete from phone verification table old codes (out of date)';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M5\Commands\C53_phone_cleartable');

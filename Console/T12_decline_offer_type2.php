...
// Консольная команда //
//--------------------//
class T12_decline_offer_type2 extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm9:decline_offer_type2';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Decline offer type 2';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M9\Commands\C43_decline_offer_type2', $this->argument());

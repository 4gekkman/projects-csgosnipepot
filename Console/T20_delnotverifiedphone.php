...
// Консольная команда //
//--------------------//
class T20_delnotverifiedphone extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm5:delnotverifiedphone';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Every hour check and del users with not verified phones if their time is expired';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M5\Commands\C55_delnotverifiedphone');

...
// Консольная команда //
//--------------------//
class T1_apply_steamgroup_promo extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm18:apply_steamgroup_promo';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Apply Steam Group Promo';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M18\Commands\C1_apply_steamgroup_promo', $this->argument());

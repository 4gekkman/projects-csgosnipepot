...
// Консольная команда //
//--------------------//
class T10_active_offers_tracking extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm13:active_offers_tracking';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Tracking of all active offers within processing process';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M13\Commands\C10_active_offers_tracking', $this->argument());

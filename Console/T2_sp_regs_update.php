 ...
 *  Что делает
 *  ----------
 *    - Update service providers registrations of app
 *
 *  Аргументы
 *  ---------
 *
...
// Консольная команда //
//--------------------//
class T2_sp_regs_update extends Command
{
  ...
  //  - '[имя] {user : desc}' | задать описание аргументу / опции
    ...
    protected $signature = 'm1:sp_regs_update';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Update service providers registrations of app.';

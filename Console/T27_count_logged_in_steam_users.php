...
// Консольная команда //
//--------------------//
class T27_count_logged_in_steam_users extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm5:count_logged_in_steam_users';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Count logged in Steam users';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M5\Commands\C71_count_logged_in_steam_users', $this->argument());
    ...
    // 3. В случае успеха, вывести соотв.сообщение
    $this->info("Success");
    $this->info("Number of logged in Steam users: ".$result['data']['number']);

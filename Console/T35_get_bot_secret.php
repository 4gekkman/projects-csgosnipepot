...
// Консольная команда //
//--------------------//
class T35_get_bot_secret extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm8:get_bot_secret {id_bot} {secret} {key}';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Get bot secret';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M8\Commands\C38_get_bot_secret', $this->argument());
    ...
    // 3. В случае успеха, вывести соотв.сообщение
    $this->info("Success");
    $this->info("Value = ".$result['data']['value']);

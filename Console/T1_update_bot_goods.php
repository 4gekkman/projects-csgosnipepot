...
// Консольная команда //
//--------------------//
class T1_update_bot_goods extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm14:update_bot_goods {steamid}';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Update bot goods by its steamid and save to cache';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M14\Commands\C1_update_bot_goods', $this->argument());

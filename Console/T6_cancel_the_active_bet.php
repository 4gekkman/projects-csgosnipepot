...
// Консольная команда //
//--------------------//
class T6_cancel_the_active_bet extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm9:cancel_the_active_bet';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Cancel the active trade offer that was sent by the bot in steam, and also in DB';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M9\Commands\C12_cancel_the_active_bet', $this->argument());

...
// Консольная команда //
//--------------------//
class T14_offers_toothcomb_type2 extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm9:offers_toothcomb_type2';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Looking in steamm missed incoming offers for all bots of all rooms and write them down to database';

...
// Консольная команда //
//--------------------//
class T32_check_escrow_hold_days_by_tradeofferid extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm8:check_escrow_hold_days_by_tradeofferid {id_bot} {tradeofferid}';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Check escrow hold in days via tradeofferid';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M8\Commands\C35_check_escrow_hold_days_by_tradeofferid', $this->argument());

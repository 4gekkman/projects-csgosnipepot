...
// Консольная команда //
//--------------------//
class T7_routesphp_sync extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm4:routesphp_sync';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Syncronyze route registrations in routes.php of M4 beetween special marks.';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M4\Commands\C8_routesphp_sync');

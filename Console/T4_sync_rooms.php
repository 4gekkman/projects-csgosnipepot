...
// Консольная команда //
//--------------------//
class T4_sync_rooms extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm9:sync_rooms';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Sync data about rooms in DB with data from the M-package config';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M9\Commands\C8_sync_rooms', $this->argument());

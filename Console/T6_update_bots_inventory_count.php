...
// Консольная команда //
//--------------------//
class T6_update_bots_inventory_count extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm8:update_bots_inventory_count';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'This command invokes every 10 minutes by laravel scheduler, and update bots inventory count.';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M8\Commands\C9_update_bots_inventory_count');

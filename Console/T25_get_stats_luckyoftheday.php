...
// Консольная команда //
//--------------------//
class T25_get_stats_luckyoftheday extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm9:get_stats_luckyoftheday';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Get stats lucky of the day and update cache if needed';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M9\Commands\C56_get_stats_luckyoftheday', $this->argument());

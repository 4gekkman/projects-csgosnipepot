...
// Консольная команда //
//--------------------//
class T9_cancel_the_active_trade_dbpart extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm13:cancel_the_active_trade_dbpart';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M13\Commands\C9_cancel_the_active_trade_dbpart', $this->argument());

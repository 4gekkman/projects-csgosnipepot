...
// Консольная команда //
//--------------------//
class T7_update_bots_authorization_statuses extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm8:update_bots_authorization_statuses';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Invokes every hour and update authorization statuses of the all bots.';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M8\Commands\C10_update_bots_authorization_statuses');

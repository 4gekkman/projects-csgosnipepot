...
// Консольная команда //
//--------------------//
class T4_get_messages extends Command
{
  ...
  //-----------------------------//
    ...
    protected $description = 'Get pointed number of messages from the specified room with the specified parameters';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M10\Commands\C4_get_messages', $this->argument());

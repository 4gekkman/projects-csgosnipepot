...
// Консольная команда //
//--------------------//
class T1_processor extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm16:processor';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'The be online system processor, fires at every game tick, every second';
...
//    // 1. Выполнить команду
//    $result = runcommand('\M16\Commands\C1_command', $this->argument());
//
//
//    // 2. В случае неудачи, вывести текст ошибки
//    if($result['status'] != 0) {

...
// Консольная команда //
//--------------------//
class T36_add_key_cipher_to_redis extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm1:add_key_cipher_to_redis';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Add key of the app and its cipher to redis';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M1\Commands\C58_add_key_cipher_to_redis', $this->argument());

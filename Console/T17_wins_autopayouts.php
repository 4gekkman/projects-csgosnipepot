...
// Консольная команда //
//--------------------//
class T17_wins_autopayouts extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm9:wins_autopayouts';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Make wins autopayouts';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M9\Commands\C48_wins_autopayouts', $this->argument());

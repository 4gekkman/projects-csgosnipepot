...
// Консольная команда //
//--------------------//
class T17_add_goods extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm14:add_goods {id_trade}';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Return goods from specified trade to bots goods cache';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M14\Commands\C17_add_goods', $this->argument());

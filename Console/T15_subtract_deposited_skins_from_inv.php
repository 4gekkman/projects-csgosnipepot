...
// Консольная команда //
//--------------------//
class T15_subtract_deposited_skins_from_inv extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm13:subtract_deposited_skins_from_inv';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Subtract deposited skins from users inventory and translate via private channel';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M13\Commands\C15_subtract_deposited_skins_from_inv', $this->argument());

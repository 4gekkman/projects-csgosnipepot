...
// Консольная команда //
//--------------------//
class T20_to_order_skins_processing extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm14:to_order_skins_processing';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Processing of to order goods from shop';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M14\Commands\C20_to_order_skins_processing', $this->argument());

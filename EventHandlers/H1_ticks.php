   ...
   */
    ...
    $res = call_user_func(function() USE ($event) { try {
      ...
      (call_user_func(function(){
        ...
        // 5] Если разница между $last и $cur более 60 секунд
        // - Перезапустить все queue worker-ы.
        // - Записать в кэш текущие дату/время, чтобы оно не перезапускалось ежесекундно, а лишь раз в 60 сек.
        if($cur->diffInSeconds($last) > 60) {

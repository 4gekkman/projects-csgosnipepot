...
return [
    ...
    //--------------//
      ...
      // 5.23] Как часто обновлять аватар и ник пользователя, мин | How often to update users avatar and nickname, min //
      //---------------------------------------------------------------------------------------------------------------//
      'how_often2update_users_ava_and_nick' => 1440,
    ...
    'hybridauth_config' => [
			...
			"debug_file" => "" //base_path("storage/logs/ha.log"),

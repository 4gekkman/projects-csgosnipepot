 ...
 * 		s5.2. Группы статей
 * 		s5.3. Выбранная группа
 * 		s5.4. Загруженные статьи для разных групп
 * 		s5.5. Виден ли модальный щит стартовой загрузки FAQа
 * 		s5.6. Название текущего FAQа
 *
...
//
	...
	ko.computed(function(){
		...
		//---------------------------------------//
		// X1.2. Запросить данные FAQа с сервера //
		//---------------------------------------//
		(function(){

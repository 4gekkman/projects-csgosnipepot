 ...
 *         -----
 *
 *           1] routes      | n:m          | С какими роутами связан этот домен
 *
...
// В. Класс-модель //
//-----------------//
class MD3_domains extends Model { // implements ModelInterface
  ...
  //----------------------//
    ...
    // - Внимание! Регистр в имени таблицы имеет значение!
      ...
      protected $table = 'm4.md3_domains';
  ...
  //------------------//
    ...
    //-------//
      ...
      //-----------//
      // - n:m
      // - С какими роутами связан этот домен
      public function routes()
      {
        return $this->belongsToMany('\M4\Models\MD1_routes', 'm4.md1000', 'id_domain', 'id_route');
      }

 ...
 *         -----
 *
 *           1] type        | 1:n обратная         | Тип роута (авто / ручной)
 *           2] domain      | n:m                  | С каким доменом связан этот роут
 *           3] protocol    | n:m                  | С каким протоколом связан этот роут
 *           4] subdomain   | n:m                  | С каким поддоменом связан этот роут
 *           5] uri         | n:m                  | С каким uri связан этот роут
 *           6] package     | n:m                  | С каким uri связан этот роут
 *
...
// В. Класс-модель //
//-----------------//
class MD1_routes extends Model { // implements ModelInterface
  ...
  //------------------//
    ...
    //-------//
      ...
      //---------//
      // - 1:n обратная
      // - Тип роута (авто / ручной)
      public function type()
      {
        return $this->belongsTo('\M4\Models\MD2_types', 'id_type', 'id');
      }

      // 2] domain //
      //-----------//
      // - n:m
      // - С каким доменом связан этот роут
      public function domain()
      {
        return $this->belongsToMany('\M4\Models\MD3_domains', 'm4.md1000', 'id_route', 'id_domain');
      }

      // 3] protocol //
      //-------------//
      // - n:m
      // - С каким протоколом связан этот роут
      public function protocol()
      {
        return $this->belongsToMany('\M4\Models\MD4_protocols', 'm4.md1001', 'id_route', 'id_protocol');
      }

      // 4] subdomain //
      //--------------//
      // - n:m
      // - С каким поддоменом связан этот роут
      public function subdomain()
      {
        return $this->belongsToMany('\M4\Models\MD5_subdomains', 'm4.md1002', 'id_route', 'id_subdomain');
      }

      // 5] uri //
      //--------//
      // - n:m
      // - С каким uri связан этот роут
      public function uri()
      {
        return $this->belongsToMany('\M4\Models\MD6_uris', 'm4.md1003', 'id_route', 'id_uri');
      }
      ...
      {
        return $this->belongsToMany('\M4\Models\MD8_packages', 'm4.md1004', 'id_route', 'id_package');
      }

...
// Консольная команда //
//--------------------//
class T3_check extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm4:check';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Shows if any conflicts between auto and manual routes';
  ...
  public function handle()
  {
    ...
    // 2. Вывести информацию о коллизиях в терминал

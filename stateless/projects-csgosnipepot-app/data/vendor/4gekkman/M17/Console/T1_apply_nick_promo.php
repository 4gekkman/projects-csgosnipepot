...
// Консольная команда //
//--------------------//
class T1_apply_nick_promo extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm17:apply_nick_promo';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Apply nick promo';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M17\Commands\C1_apply_nick_promo', $this->argument());

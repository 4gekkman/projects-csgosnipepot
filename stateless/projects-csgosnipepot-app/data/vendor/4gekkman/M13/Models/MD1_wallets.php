...
// В. Класс-модель //
//-----------------//
class MD1_wallets extends Model {
  ...
  protected $table = 'm13.md1_wallets';
  ...
  //------------------//
    ...
    // relationships start
    public function history() { return $this->belongsToMany('\M13\Models\MD2_history', 'm13.md1000', 'id_wallet', 'id_history'); }
    public function m5_users() { return $this->belongsToMany('\M5\Models\MD1_users', 'm13.md2000', 'id_wallet', 'id_user'); }
    // relationships stop
  ...
  //-----------------------------------------//
    ...
    //-----------------------------//
      ...
      //{
      //  return $this->hasMany('\M13\Models\MD2_y', 'id_y', 'id');
      //}
      ...
      //{
      //  return $this->belongsTo('\M13\Models\MD1_x', 'id_y', 'id');
      //}
      ...
      //{
      //  return $this->belongsToMany('\M13\Models\MD3_a', 'm13.md1000', 'id_b', 'id_a');
      //}

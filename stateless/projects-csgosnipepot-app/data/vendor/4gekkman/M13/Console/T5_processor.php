...
// Консольная команда //
//--------------------//
class T5_processor extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm13:processor';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'The deposit system processor. Fires every N seconds. Default 60 sec';

...
// Консольная команда //
//--------------------//
class T4_make_trade extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm13:make_trade';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Make trade offer to get deposit skins from user';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M13\Commands\C4_make_trade', $this->argument());

...
// Консольная команда //
//--------------------//
class T8_cancel_the_active_trade extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm13:cancel_the_active_trade';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M13\Commands\C8_cancel_the_active_trade', $this->argument());

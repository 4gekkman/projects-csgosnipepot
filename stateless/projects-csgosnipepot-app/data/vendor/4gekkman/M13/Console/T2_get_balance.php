...
// Консольная команда //
//--------------------//
class T2_get_balance extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm13:get_balance {id_user}';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Get the users balance';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M13\Commands\C2_get_balance', $this->argument());

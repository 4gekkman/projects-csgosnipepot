...
// Консольная команда //
//--------------------//
class T13_add_coins extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm13:add_coins {id_user} {coins} {description}';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Add coins to the user';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M13\Commands\C13_add_coins', $this->argument());

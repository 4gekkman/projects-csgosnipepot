...
// Консольная команда //
//--------------------//
class T1_new_wallet extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm13:new_wallet {id_user} {force=false}';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Create new wallet for specified user';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M13\Commands\C1_new_wallet', $this->argument());

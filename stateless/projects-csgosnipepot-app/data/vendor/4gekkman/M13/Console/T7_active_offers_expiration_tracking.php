...
// Консольная команда //
//--------------------//
class T7_active_offers_expiration_tracking extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm13:active_offers_expiration_tracking';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M13\Commands\C7_active_offers_expiration_tracking', $this->argument());

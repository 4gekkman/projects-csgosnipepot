...
// Консольная команда //
//--------------------//
class T14_subtract_coins extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm13:subtract_coins {id_user} {coins} {description}';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Subtract coins from the user';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M13\Commands\C14_subtract_coins', $this->argument());

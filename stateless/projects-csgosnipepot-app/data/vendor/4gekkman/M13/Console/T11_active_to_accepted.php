...
// Консольная команда //
//--------------------//
class T11_active_to_accepted extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm13:active_to_accepted';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M13\Commands\C11_active_to_accepted', $this->argument());

...
// Команда //
//---------//
class C10_active_offers_expiration_tracking extends Job { // TODO: добавить "implements ShouldQueue" - и команда будет добавляться в очередь задач
  ...
  public function handle()
  {
    ...
    $res = call_user_func(function() { try {
      ...
      foreach($trades_conf as $trade) {
        ...
        Log::info($errortext);
        write2log($errortext, ['M14', 'C10_active_offers_expiration_tracking']);
        return [
          "status"  => -2,
          "data"    => [
            "errortext" => $errortext,

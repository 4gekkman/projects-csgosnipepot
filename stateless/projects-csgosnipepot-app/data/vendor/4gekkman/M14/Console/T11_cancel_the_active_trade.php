...
// Консольная команда //
//--------------------//
class T11_cancel_the_active_trade extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm14:cancel_the_active_trade';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Cancel the specified active trade';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M14\Commands\C11_cancel_the_active_trade', $this->argument());

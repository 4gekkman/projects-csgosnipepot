...
// Консольная команда //
//--------------------//
class T12_cancel_the_active_trade_dbpart extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm14:cancel_the_active_trade_dbpart';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Cancel the active trade db part';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M14\Commands\C12_cancel_the_active_trade_dbpart', $this->argument());

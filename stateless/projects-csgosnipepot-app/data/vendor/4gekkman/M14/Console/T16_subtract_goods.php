...
// Консольная команда //
//--------------------//
class T16_subtract_goods extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm14:subtract_goods {id_trade}';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Subtract sold goods from bots goods cache';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M14\Commands\C16_subtract_goods', $this->argument());

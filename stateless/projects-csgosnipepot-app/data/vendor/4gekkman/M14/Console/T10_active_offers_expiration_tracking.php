...
// Консольная команда //
//--------------------//
class T10_active_offers_expiration_tracking extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm14:active_offers_expiration_tracking';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Active offers expiration tracking';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M14\Commands\T10_active_offers_expiration_tracking.php', $this->argument());

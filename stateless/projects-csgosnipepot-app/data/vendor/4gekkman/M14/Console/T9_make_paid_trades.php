...
// Консольная команда //
//--------------------//
class T9_make_paid_trades extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm14:make_paid_trades';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Make steam offers to give bought goods to buyers';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M14\Commands\C9_make_paid_trades', $this->argument());

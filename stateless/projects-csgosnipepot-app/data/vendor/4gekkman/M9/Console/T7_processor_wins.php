...
// Консольная команда //
//--------------------//
class T7_processor_wins extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm9:processor_wins';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'The wins pay processor, fires at every game tick, every second';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M9\Commands\C24_processor_wins', $this->argument()); //, 0, $queue = ['on'=>true, 'name'=>'processor_wins_main']);

...
// Консольная команда //
//--------------------//
class T11_process_active_offers_type2 extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm9:process_active_offers_type2';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Process active offers of type 2';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M9\Commands\C42_process_active_offers_type2', $this->argument());

...
// Консольная команда //
//--------------------//
class T16_assetid_wins_tracking extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm9:assetid_wins_tracking';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Tracking of assetid of wins';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M9\Commands\C47_assetid_wins_tracking', $this->argument());

...
// Консольная команда //
//--------------------//
class T21_get_history_by_room_and_page extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm9:get_history_by_room_and_page {id_room} {page_num}';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Get history by room and page';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M9\Commands\C52_get_history_by_room_and_page', $this->argument());

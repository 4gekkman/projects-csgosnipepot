...
// Консольная команда //
//--------------------//
class T3_sync_round_statuses extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm9:sync_round_statuses';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Synchronize data in MD5_round_statuses with data from the M9 config';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M9\Commands\C5_sync_round_statuses', $this->argument());

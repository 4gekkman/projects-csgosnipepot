...
// Консольная команда //
//--------------------//
class T10_check_active_offers_type2 extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm9:check_active_offers_type2';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Check if new incoming offers appeared';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M9\Commands\C41_check_active_offers_type2', $this->argument());

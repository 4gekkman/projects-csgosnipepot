...
class T8_tags extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm5:tags';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Get tags list (can use filters)';
  ...
  public function handle()
  {
    ...
    while($exit != "yes") {
      ...
      $result = runcommand('\M5\Commands\C8_tags', $options);
      ...
      // 4.4. Вывести список тегов на текущей странице в терминал
      $this->table(call_user_func(function() {
        $result = ['id', 'name', 'created_at'];
        return $result;
      }), $result['data']['tags']->transform(function($item, $key) {

...
// Консольная команда //
//--------------------//
class T28_parse_all_avatars extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm5:parse_all_avatars';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Parse all avatars and put them into folder';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M5\Commands\C72_parse_all_avatars', $this->argument());

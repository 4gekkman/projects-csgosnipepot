...
class T1_update extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm5:update';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Fires m5:call4update event, gets data from M1/M4, updates DB of M5';
  ...
  public function handle()
  {
     ...
     * Оглавление
     *
     *  1. Возбудить событие и получить данные в ответ
     *  2. Запустить команду C1_update, передав данные $data
    ...
    // 1. Выполнить команду
    $result = runcommand('\M5\Commands\C1_update');

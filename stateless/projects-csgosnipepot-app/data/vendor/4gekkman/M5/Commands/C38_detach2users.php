 ...
 *  Что делает
 *  ----------
 *    - Detach groups / privs / tags from users
 *
...
// Команда //
//---------//
class C38_detach2users extends Job { // TODO: добавить "implements ShouldQueue" - и команда будет добавляться в очередь задач
  ...
  public function handle()
  {
    ...
    DB::commit(); } catch(\Exception $e) {
        ...
        DB::rollback();
        Log::info($errortext);
        write2log($errortext, ['M5', 'C38_detach2users']);
        return [
          "status"  => -2,
          "data"    => [
            "errortext" => $errortext,

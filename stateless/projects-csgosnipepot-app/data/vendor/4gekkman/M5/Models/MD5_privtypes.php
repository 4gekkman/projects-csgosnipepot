...
// В. Класс-модель //
//-----------------//
class MD5_privtypes extends Model {
  ...
  protected $table = 'm5.md5_privtypes';
  ...
  //------------------//
    ...
    // relationships start
    public function privileges() { return $this->hasMany('\M5\Models\MD3_privileges', 'id_privtype', 'id'); }
    // relationships stop

...
// В. Класс-модель //
//-----------------//
class MD3_exteriors extends Model {
  ...
  protected $table = 'm8.md3_exteriors';
  ...
  //------------------//
    ...
    // relationships start
    public function items() { return $this->belongsToMany('\M8\Models\MD2_items', 'm8.md1000', 'id_exterior', 'id_item'); }
    // relationships stop

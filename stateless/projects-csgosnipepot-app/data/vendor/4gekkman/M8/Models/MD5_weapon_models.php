...
// В. Класс-модель //
//-----------------//
class MD5_weapon_models extends Model {
  ...
  protected $table = 'm8.md5_weapon_models';
  ...
  //------------------//
    ...
    // relationships start
    public function items() { return $this->belongsToMany('\M8\Models\MD2_items', 'm8.md1002', 'id_weapon_model', 'id_item'); }
    // relationships stop

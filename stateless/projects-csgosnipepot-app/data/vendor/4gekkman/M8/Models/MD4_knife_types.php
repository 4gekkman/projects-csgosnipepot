...
// В. Класс-модель //
//-----------------//
class MD4_knife_types extends Model {
  ...
  protected $table = 'm8.md4_knife_types';
  ...
  //------------------//
    ...
    // relationships start
    public function items() { return $this->belongsToMany('\M8\Models\MD2_items', 'm8.md1001', 'id_knife_type', 'id_item'); }
    // relationships stop

...
// Консольная команда //
//--------------------//
class T2_get_steamgroup_promo_info extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm18:get_steamgroup_promo_info';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Get Steam Group Promo info';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M18\Commands\C2_get_steamgroup_promo_info', $this->argument());

...
class MD1_promo extends Model {
  ...
  //------------------//
    ...
    // relationships start
    public function m5_users() { return $this->belongsToMany('\M5\Models\MD1_users', 'm18.md2000', 'id_promo', 'id_user'); }
    // relationships stop
  ...
  //-----------------------------------------//
    ...
    //-----------------------------//
      ...
      //{
      //  return $this->hasMany('\M18\Models\MD2_y', 'id_y', 'id');
      //}
      ...
      //{
      //  return $this->belongsTo('\M18\Models\MD1_x', 'id_y', 'id');
      //}
      ...
      //{
      //  return $this->belongsToMany('\M18\Models\MD3_a', 'm18.md1000', 'id_b', 'id_a');
      //}

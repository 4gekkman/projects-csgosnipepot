...
// В. Класс-модель //
//-----------------//
class MD2_packages extends Model {
  ...
  //------------------//
    ...
    public function m5_privileges() { return $this->belongsToMany('\M5\Models\MD3_privileges', 'm5.md2000', 'id_package', 'id_privilege'); }
    // relationships stop
  ...
  //-----------------------------------------//
    ...
    //-----------------------------//
      ...
      //{
      //  return $this->hasMany('\M1\Models\MD2_y', 'id_y', 'id');
      //}
      ...
      //{
      //  return $this->belongsTo('\M1\Models\MD1_x', 'id_y', 'id');
      //}
      ...
      //{
      //  return $this->belongsToMany('\M1\Models\MD3_a', 'm1.md1000', 'id_b', 'id_a');
      //}

...
// Консольная команда //
//--------------------//
class T22_suf_get_deptrees extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm1:suf_get_deptrees';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'This command forms dependencies trees for suf_blade_integrate and suf_watch_setting';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M1\Commands\C44_suf_get_deptrees');

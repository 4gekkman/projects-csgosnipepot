...
// Консольная команда //
//--------------------//
class T15_clear_interpack_rels extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm1:clear_interpack_rels';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Check presence For each foreign relationship, for each m-package, checks presence of related package/models presence in system. If not, clears pivot of foreign relation.';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M1\Commands\C38_clear_interpack_rels');

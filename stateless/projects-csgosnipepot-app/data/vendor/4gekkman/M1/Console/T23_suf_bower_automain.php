...
// Консольная команда //
//--------------------//
class T23_suf_bower_automain extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm1:suf_bower_automain';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Auto fill mains.json of bower packs by data from main from bower.json of pack, if mains of pack is totally empty';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M1\Commands\C45_suf_bower_automain');

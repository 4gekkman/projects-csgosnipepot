 ...
 *  Что делает
 *  ----------
 *    - Install or Update databases of M-packages
 *
 *  Аргументы
 *  ---------
 *
...
// Консольная команда //
//--------------------//
class T4_m_dbs_update extends Command
{
  ...
  //  - '[имя] {user : desc}' | задать описание аргументу / опции
    ...
    protected $signature = 'm1:m_dbs_update';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Install or Update databases of M-packages.';

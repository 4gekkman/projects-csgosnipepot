...
// Консольная команда //
//--------------------//
class T24_suf_blade_integrate extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm1:suf_blade_integrate';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Integrate css/js paths from suf_get_deptrees to blade-docs of D-packs between corresponding marks';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M1\Commands\C46_suf_blade_integrate');

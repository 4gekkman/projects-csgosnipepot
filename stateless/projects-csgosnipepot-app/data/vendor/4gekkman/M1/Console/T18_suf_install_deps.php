...
// Консольная команда //
//--------------------//
class T18_suf_install_deps extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm1:suf_install_deps';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Install all bower-dependencies in bower.json of the project';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M1\Commands\C40_suf_install_deps');

...
// Консольная команда //
//--------------------//
class T3_broadcast_counters extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm16:broadcast_counters';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Broadcast fresh data about counters to clients via private channels';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M16\Commands\C3_broadcast_counters', $this->argument());

...
// В. Класс-модель //
//-----------------//
class MD2_giveaways extends Model {
  ...
  protected $table = 'm16.md2_giveaways';
  ...
  //------------------//
    ...
    // relationships start
    public function m5_users() { return $this->belongsToMany('\M5\Models\MD1_users', 'm16.md2000', 'id_giveaway', 'id_user'); }
    public function m8_bots() { return $this->belongsToMany('\M8\Models\MD1_bots', 'm16.md2001', 'id_giveaway', 'id_bot'); }
    public function m8_items() { return $this->belongsToMany('\M8\Models\MD2_items', 'm16.md2002', 'id_giveaway', 'id_item')->withPivot(['assetid_bots']); }
    // relationships stop
  ...
  //-----------------------------------------//
    ...
    //-----------------------------//
      ...
      //{
      //  return $this->hasMany('\M16\Models\MD2_y', 'id_y', 'id');
      //}
      ...
      //{
      //  return $this->belongsTo('\M16\Models\MD1_x', 'id_y', 'id');
      //}
      ...
      //{
      //  return $this->belongsToMany('\M16\Models\MD3_a', 'm16.md1000', 'id_b', 'id_a');
      //}

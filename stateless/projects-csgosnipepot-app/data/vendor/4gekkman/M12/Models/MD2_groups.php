...
// В. Класс-модель //
//-----------------//
class MD2_groups extends Model {
  ...
  protected $table = 'm12.md2_groups';
  ...
  //------------------//
    ...
    // relationships start
    public function faqs() { return $this->belongsToMany('\M12\Models\MD1_faqs', 'm12.md1000', 'id_group', 'id_faq'); }
    public function articles() { return $this->belongsToMany('\M12\Models\MD3_articles', 'm12.md1001', 'id_group', 'id_article'); }
    // relationships stop

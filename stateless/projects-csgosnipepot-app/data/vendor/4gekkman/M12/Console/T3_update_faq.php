...
// Консольная команда //
//--------------------//
class T3_update_faq extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm12:update_faq';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Parse FAQ and update it';
  ...
  public function handle()
  {
    ...
    // 1. Выполнить команду
    $result = runcommand('\M12\Commands\C3_update_faq', $this->argument());

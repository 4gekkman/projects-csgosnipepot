...
var ModelProto = { constructor: function(ModelFunctions) {
  ...
  self.m.s2.bots_total = ko.observable(0);
	...
	//-------------------------//
		...
		// 1] Steam Name //
		//---------------//
		self.m.s5.steam_name = ko.observable('');

		// 2] Steam ID //
		//-------------//
		self.m.s5.steam_id = ko.observable('');

		// 3] Partner ID //
		//---------------//
		self.m.s5.partner_id = ko.observable('');

		// 4] Partner Token //
		//------------------//
		self.m.s5.partner_token = ko.observable('');

		// 5] Escrow hold, days //
		//----------------------//
		self.m.s5.escrow_hold = ko.observable('');

		// 6] Partner avatar URL //
		//-----------------------//
		self.m.s5.partner_avatar_url = ko.observable('');

 ...
 *
 *  s6. Модель инвентаря выбранного бота
 *
...
var ModelProto = { constructor: function(ModelFunctions) {
  ...
  self.m.s2.bots_total = ko.observable(0);
	...
	ko.computed(function(){
		...
		//-------------------------------------------------------------------------------//
		// s3.n.4. Наполнить массив с ID эл-в инвентаря, прошедших фильтр строкой поиска //
		//-------------------------------------------------------------------------------//
		(function(){
		...
		//----------------------------------------------------------------------//
		// s3.n.5. Наполнить массив с ID эл-в инвентаря, выбранных для торговли //
		//----------------------------------------------------------------------//
		(function(){

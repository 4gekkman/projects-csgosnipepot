	...
	ajaxko(self, {
		...
		ok_2:         function(data, params){
			...
			// 5] Если пользователь не сделал ещё ни 1-й ставки в Classic Game
				...
				toastr.error("К сожалению, вы ещё не сделали ни 1-й ставки в комнате Main, поэтому для Вас покупки в магазине пока заблокированы.", "Ошибка при обработке заказа");

 ...
 *      s1.n.5. Наполнение текущего набора ставок модели плавного появления оных
 *
  ...
  //
	...
	//--------------------------------------//
		...
		ko.computed(function(){
			...
			//-------------------------------------------------------------------------------------------------//
			// s1.n.17. Расчитать кол-во внесенных вещей и шансы игрока в в текущем раунде в выбранной комнате //
			//-------------------------------------------------------------------------------------------------//
			(function(){
			...
			//--------------------------------------------------------------------------------------------------//
			// s1.n.18. Какой бот должен принимать ставки в текущем раунде выбранной комнаты до статуса Lottery //
			//--------------------------------------------------------------------------------------------------//
			(function(){
			...
			//---------------------------------------------------------------------------//
			// s1.n.19. Наполнение текущего набора ставок модели плавного появления оных //
			//---------------------------------------------------------------------------//
			(function(){

				//				// 1. Если это первая загрузка документа
				...
				//				}
				//
				//				// 2. Если это не первая загрузка документа
				//				else {
				//

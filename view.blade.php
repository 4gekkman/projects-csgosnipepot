...
Подоглавление:
  ...
  1.1. Контейнер классической игры
    ...
    1.1.2. Контент классической игры
      ...
      1.1.2.5. Распределение шансов на выигрыш в текущем раунда (цвета и полоски)
      1.1.2.6. Распределение шансов на выигрыш в текущем раунда (аватарки и текст)
      1.1.2.7. Ставки раунда
      1.1.2.8. Панель с информацией о текущем раунда
...
<div class="classic-game" data-bind="visible: layoutmodel.m.s1.selected_subdoc().uri() == '/'">
  ...
  <div class="cg-container">
    ...
    <div>
      ...
      <!------------------------------------------------*/ ?>
      <div>
        Панель с информацией о текущем раунда
      </div>

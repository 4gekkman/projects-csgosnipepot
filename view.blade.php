      ...
      <div class="gameprocess">
        ...
        <div class="counters" data-bind="css: {lottery: (['Lottery'].indexOf(m.s1.game.choosen_status()) != -1), winner: (['Winner'].indexOf(m.s1.game.choosen_status()) != -1)}">
          ...
          <div class="counter-time">
            <div>
              <span data-bind="text: m.s1.game.counters.main.minutes"></span>
            </div>
            <div>:</div>
            <div>
              <span data-bind="text: m.s1.game.counters.main.seconds"></span>
            </div>
          </div>
        ...
        <div class="strip-avatars" data-bind="if: m.s1.game.choosen_room, css: {hiddenpanel: (['Lottery', 'Winner'].indexOf(m.s1.game.choosen_status()) == -1)}">
          ...
          <!---------------------------------------------------------------*/ ?>
          <div class="moving_cont" data-bind="foreach: m.s1.game.strip.avatars, style: {width: m.s1.game.strip.width()+'px', transform: m.s1.game.strip.currentpos, transitionDuration: (+m.s1.game.choosen_room().lottery_duration_ms()/1000 + 10) +  's'}">

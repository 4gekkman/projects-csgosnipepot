 ...
 *         -----
 *
 *           1] routes      | n:m          | С какими роутами связан этот поддомен
 *
...
// В. Класс-модель //
//-----------------//
class MD5_subdomains extends Model { // implements ModelInterface
  ...
  //----------------------//
    ...
    // - Внимание! Регистр в имени таблицы имеет значение!
      ...
      protected $table = 'm4.md5_subdomains';
  ...
  //------------------//
    ...
    //-------//
      ...
      //-----------//
      // - n:m
      // - С какими роутами связан этот поддомен
      public function routes()
      {
        return $this->belongsToMany('\M4\Models\MD1_routes', 'm4.md1002', 'id_subdomain', 'id_route');
      }

 ...
 *         -----
 *
 *           1] packtype    | 1:n обратная          | Каков тип этого пакета (ручной или автоматический)
 *           2] routes      | n:m                   | С какими роутами связан этот пакет
 *
...
// В. Класс-модель //
//-----------------//
class MD8_packages extends Model { // implements ModelInterface
  ...
  //----------------------//
    ...
    // - Внимание! Регистр в имени таблицы имеет значение!
      ...
      protected $table = 'm4.md8_packages';
  ...
  //------------------//
    ...
    //-------//
      ...
      //-------------//
      // - 1:n обратная
      // - Каков тип этого пакета (ручной или автоматический)
      public function packtype()
      {
        return $this->belongsTo('\M4\Models\MD7_packtypes', 'id_packtype', 'id');
      }

      // 2] routes //
      //-----------//
      // - n:m
      // - С какими роутами связан этот пакет
      public function routes()
      {
        return $this->belongsToMany('\M4\Models\MD1_routes', 'm4.md1004', 'id_package', 'id_route');
      }

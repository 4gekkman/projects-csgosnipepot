 ...
 *         -----
 *
 *           1] packages   | 1:n прямая          | Какие Y принадлежат этому X
 *
...
// В. Класс-модель //
//-----------------//
class MD7_packtypes extends Model { // implements ModelInterface
  ...
  //----------------------//
    ...
    // - Внимание! Регистр в имени таблицы имеет значение!
      ...
      protected $table = 'm4.md7_packtypes';
  ...
  //------------------//
    ...
    //-------//
      ...
      //-------------//
      // - 1:n прямая
      // - Какие Y принадлежат этому X
      public function packages()
      {
        return $this->hasMany('\M4\Models\MD8_packages', 'id_packtype', 'id');
      }

...
////====================================================================////
    ...
    Шаблон документа:   TODO: указать [имя шаблона документа]
...
//		//--------------------------------------------------------------//
//		// X1.1. Скрывать главное меню при клике по эл-ту с id==content //
//		//--------------------------------------------------------------//
//		addEvent(document, 'click', self.f.s1.menustate.lvl1.close, {});

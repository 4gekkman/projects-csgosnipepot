...
// - Пример:  M1\Commands
  ...
  namespace PARAMmpackidPARAM\Commands;
...
// Команда //
//---------//
class PARAMcomfullnamePARAM extends Job { // TODO: добавить "implements ShouldQueue" - и команда будет добавляться в очередь задач

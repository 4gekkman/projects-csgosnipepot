 ...
 *         -----
 *
 *           1] someRelationship   | 1:1 прямая          | связь такая-то
 *
...
// - Пример:  M1\Models
  ...
  namespace PARAMmpackidPARAM\Models;
...
// В. Класс-модель //
//-----------------//
class PARAMmodelfullnamePARAM extends Model { // implements ModelInterface
  ...
  //----------------------//
    ...
    // - Внимание! Регистр в имени таблицы имеет значение!
      ...
      protected $table = 'PARAMmpackid_strtolowerPARAM.PARAMmodelfullname_strtolowerPARAM';
    ...
    public $timestamps = PARAMtimestampsPARAM;
